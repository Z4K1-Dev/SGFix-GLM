...
export function MobileHeader({ 
  ...
  return (
    <header className="bg-transparent text-foreground p-3 shadow-md sticky top-0 z-40">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          {showBackButton && (
            <button 
              onClick={handleBack}
              className="inline-flex items-center justify-center rounded-md hover:bg-muted h-8 w-8 p-0 text-foreground"
            >
        ...
        <div className="flex items-center gap-2">
          ...
          <Sheet open={notifOpen} onOpenChange={setNotifOpen}>
            <button
              ...
              className="relative inline-flex items-center justify-center rounded-md hover:bg-muted h-8 w-8 p-0 text-foreground"
            >
              <Bell size={18} />
              {badgeCount > 0 && (
